          ...
          <div className="container space-y-12 px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-black">Los efectos devastadores del bullying</h2>
            ...
            <div className="mx-auto grid items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
              <div className="grid gap-1">
                <h3 className="text-lg font-bold text-black">Impactos en la salud mental</h3>
                <p className="text-sm text-black">
                  El bullying puede llevar a depresión, ansiedad, baja autoestima y, en casos graves, pensamientos suicidas.
                </p>
              </div>
              <div className="grid gap-1">
                <h3 className="text-lg font-bold text-black">Impactos en la salud física</h3>
                <p className="text-sm text-black">
              ...
              <div className="grid gap-1">
                <h3 className="text-lg font-bold text-black">Impactos académicos y sociales</h3>
                <p className="text-sm text-black">
